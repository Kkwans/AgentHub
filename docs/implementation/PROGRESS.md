...
- M34 PromptOS Presentation 收口已提交为 `8adb2a5`：版本/Skill 来源、创建者与 Binding 解析顺序统一通过中文 Presentation 映射；同时修正“数字越小越优先”的表单说明。聚焦测试 2 files/4 tests、lint、typecheck、build 通过。完整记录见 `docs/qa/v06-promptos-presentation/`；尚未部署 NAS。

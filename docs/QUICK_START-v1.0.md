...
- 视觉验收使用 NAS 本地 Playwright Chromium 连接真实部署目标；不能把自动化 fixture、静态 build 或 curl 当作真实部署视觉证据。

遇到问题先查看 [`docs/TROUBLESHOOTING.md`](TROUBLESHOOTING.md)、[`docs/AGENT-INTEGRATION.md`](AGENT-INTEGRATION.md) 和 [`docs/RELEASE-v1.0.0.md`](RELEASE-v1.0.0.md)。

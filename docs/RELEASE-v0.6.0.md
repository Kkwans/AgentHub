...
- PromptOS 版本/Skill 来源、创建者与 Binding 解析顺序统一使用中文 Presentation；解析顺序说明与服务端“数字越小越优先”保持一致。代码证据见 [`docs/qa/v06-promptos-presentation/README.md`](qa/v06-promptos-presentation/README.md)，尚未部署 NAS。

...
| 层级                     | 结果                                                                                                                                                                                        |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Vitest                   | 44 个文件通过，3 个 live 文件跳过；182 passed、8 skipped                                                                                                                                    |
| typecheck / lint / build | 通过；Web 1711 modules transformed                                                                                                                                                          |
| Playwright E2E           | 24/24 通过，覆盖 1440/1024/768/390、URL 恢复、键盘与 axe                                                                                                                                    |
| real live gate           | 3 个文件、8 个测试通过，包含真实 Codex 文件变更/Diff/commit、Remote Node、Worktree Review/Merge 与 Docker Agent smoke                                                                       |
| GitHub Actions           | run `31884092817`，commit `4eb548d`，lint/typecheck/test/build/Playwright E2E 全绿                                                                                                          |
| NAS Compose              | `agenthub:0.6.0-nas.3`，ARM64，revision `4eb548d`，`running/healthy`，`192.168.5.110:3210`                                                                                                  |
...
完整 NAS 记录见 [`docs/qa/nas/2026-08-15-v06-live3/README.md`](qa/nas/2026-08-15-v06-live3/README.md)。
...
ACP/live nas.3 的当前记录见 [`docs/qa/nas/2026-08-15-v06-live3/`](qa/nas/2026-08-15-v06-live3/)。

...
| GitHub Actions | run `31777520674`，commit `1ad230e`，lint/typecheck/test/build/Playwright E2E 全绿 |
| NAS Compose | `agenthub:0.6.0-nas.2`，ARM64，revision `1ad230e`，`running/healthy`，`192.168.5.110:3210` |
...
本次 UI/可访问性修复的完整 NAS 记录见 [`docs/qa/nas/2026-08-14-v06-ui2/`](qa/nas/2026-08-14-v06-ui2/)。

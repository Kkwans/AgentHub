...
- UI 切片必须使用 Playwright 对真实部署目标执行自动化视觉门禁，优先在 NAS 本地运行 Chromium；至少覆盖 1440/1024/768/390 四个视口、console/页面错误、横向溢出和关键交互断言。如果当前没有任何浏览器运行能力，明确记录视觉门禁未验证，不得把静态构建或 fixture 当作证据。
